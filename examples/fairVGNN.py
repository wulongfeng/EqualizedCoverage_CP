from FairGNNs.models import FairVGNN
...
for epo in [350, 400, 450, 500]:
    model = FairVGNN()
    model.fit(adj, feats, labels, idx_train, idx_val, idx_test, sens, params["sens_attr_idx"], runs=1, epochs=epo, dataset=params['dataset'])
    ...
    (
        ...
        cov_nosen,
        ineff_nosen
    ) =  model.predict(labels, calib_test_mask, sensitive_mask, no_sensitive_mask, n_sample, params['alpha'])
